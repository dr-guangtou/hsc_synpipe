...
% This is the single column version used for submission
...
\subsubsection{Injection of Synthetic Objects into Single-\visit{} Images}
    ...
    \begin{itemize}
        ...
        \item With the help of \galsim{} module, \synpipe{} simulate the images of
            ...
            \item \song{For galaxy using any parametric model, we generate rectangular 
                cutout image that contains all . 
                The model image can be truncated at $N \times R_{\rm e}$ to reduce the 
                size of the cutout and speed up the injection process. 
                In this work, we truncate all \ser{} model at $12 \times R_{\rm e}$. 
...
\begin{figure*}
    ...
    \caption{
         ...
         galaxies. 
         \texttt{lower panels} \song{show the \textbf{input} parameters of the \ser{} 
...
\begin{figure*}
    ...
    \caption{
        ...
        \song{Highly blended stars with $b > 0.05$} are highlighted using scatter plots.
...
\begin{figure*}
    ...
    \caption{
        ...
        \song{Highly blended objects with $b > 0.05$} are highlighted using scattered 
        points.
