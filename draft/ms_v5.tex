...
\begin{abstract}
    ...
    $i{\sim}25.5$ in the $i$-band (corresponding to statistical accuracies of 
    ${\sim}0.01$ and ${\sim}0.06$ mag respectively).  
    ...
    in the $i$-band (corresponding to statistical accuracies of ${\sim}0.14$ and 
    ${\sim}0.20$ mag respectively). 
