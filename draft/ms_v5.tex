...
\subsubsection{Precision and Accuracy of PSF colors}
    ...
    colors. 
    Figure \ref{fig:psf_color} shows that \hscpipe{} provides precise and accurate PSF 
    ...
    Figure \ref{fig:psf_color} shows that the precision of PSF colors do not depend 
    ...
    Figure \ref{fig:psf_cdist} displays the precision of PSF colors by comparing the 
...
\subsubsection{Input magnitude and the \s2n{} of \cmodel{} photometry}
    ...
    Figure \ref{fig:cmodel_sn} shows the relation between the input magnitudes and the 
    ...
    Figure \ref{fig:cmodel_sn} shows that the \cmodel{} photometry displays a 
...
\subsubsection{Precision and Accuracy of the \cmodel{} magnitude}
    ...
    At the same time, Figure \ref{fig:cmodel_mag} shows that the \cmodel{} algorithm in
