...
\subsection{cModel photometry of Galaxies}
    ...
    $i_{\mathrm{CModel}} < 25.5$ mag. 
        We randomly inject ${\sim}40,000$ synthetic galaxies into each \tract{}. 

    so we inject additional ${\sim}10$\% extended 
    objects to the images. 
    Using an approach similar to that for synthetic stars, we select 
