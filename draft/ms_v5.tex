...
\begin{table*}
    ...
    \hline
    $g$ & 0.45 & Precision & 0.016 & 0.017 & 0.019 & 0.023 & 0.029 & 0.043 & 0.078 \\
        &      & Accuracy  & 0.008 & 0.009 & 0.009 & 0.009 & 0.008 & 0.007 & $\minus 0.003$ \\
        \cline{3-10}
        & 0.70 & Precision & 0.016 & 0.018 & 0.019 & 0.021 & 0.026 & 0.039 & 0.091 \\
        &      & Accuracy  & 0.007 & 0.006 & 0.006 & 0.005 & 0.004 & 0.003 & $\minus 0.002$ \\
    \hline
    $r$ & 0.45 & Precision & 0.021 & 0.023 & 0.024 & 0.025 & 0.027 & 0.035 & 0.064 \\
        &      & Accuracy  & 0.011 & 0.011 & 0.012 & 0.011 & 0.012 & 0.011 & 0.011 \\
        \cline{3-10}
        & 0.70 & Precision & 0.026 & 0.029 & 0.031 & 0.034 & 0.041 & 0.054 & 0.090 \\
        &      & Accuracy  & 0.009 & 0.009 & 0.009 & 0.009 & 0.009 & 0.006 & 0.001 \\    
    \hline
    $i$ & 0.45 & Precision & 0.015 & 0.015 & 0.017 & 0.018 & 0.020 & 0.030 & 0.047 \\
        &      & Accuracy  & 0.002 & 0.002 & 0.002 & 0.002 & 0.002 & 0.002 & 0.003 \\
        \cline{3-10}
        & 0.70 & Precision & 0.012 & 0.013 & 0.014 & 0.016 & 0.022 & 0.043 & 0.050 \\
        &      & Accuracy  & 0.001 & 0.002 & 0.002 & 0.002 & 0.002 & 0.001 & $\minus 0.012$ \\    
    \hline
    $z$ & 0.45 & Precision & 0.011 & 0.013 & 0.014 & 0.016 & 0.025 & 0.053 & 0.094 \\
        &      & Accuracy  & 0.002 & 0.002 & 0.002 & 0.003 & 0.003 & 0.005 & $\minus 0.001$ \\
        \cline{3-10}
        & 0.70 & Precision & 0.019 & 0.020 & 0.021 & 0.024 & 0.038 & 0.071 & 0.104 \\
        &      & Accuracy  & 0.003 & 0.003 & 0.003 & 0.004 & 0.005 & 0.003 & $\minus 0.010$ \\    
    \hline
    $y$ & 0.45 & Precision & 0.017 & 0.017 & 0.021 & 0.033 & 0.074 & 0.138 & -- \\
        &      & Accuracy  & 0.006 & 0.006 & 0.006 & 0.006 & 0.000 & $\minus 0.001$ & -- \\
        \cline{3-10}
        & 0.70 & Precision & 0.019 & 0.019 & 0.023 & 0.037 & 0.077 & 0.153 & -- \\
        &      & Accuracy  & 0.007 & 0.008 & 0.008 & 0.006 & 0.003 & $\minus 0.034$ & -- \\    
    \hline  
    \end{tabular}
    %% -------------------------------------------------------------------------------- %%
    \end{center}
    \caption{
        \todo{Placeholder}
        Summary of the precisions and accuracies of \forced{} PSF magnitudes in all 
...
\begin{table*}
    ...
    \cline{4-10}
           & FWHM ($$\asec) &             & 19.0 & 20.0 & 21.0 & 22.0 & 23.0 & 24.0 & 25.0 \\
    \hline
    $(g-i)$ & 0.45 & Precision & 0.023 & 0.026 & 0.037 & 0.054 & 0.077 & 0.105 & 0.117 \\
            &      & Accuracy  & 0.008 & 0.007 & 0.005 & 0.003 & $\minus 0.002$ & $\minus 0.009$ & $\minus 0.035$ \\
            \cline{3-10}
            & 0.70 & Precision & 0.021 & 0.025 & 0.033 & 0.051 & 0.075 & 0.105 & 0.137 \\
            &      & Accuracy  & 0.004 & 0.003 & 0.002 & 0.001 & $\minus 0.001$ & $\minus 0.002$ & 0.007 \\
    \hline
    $(i-y)$ & 0.45 & Precision & 0.019 & 0.020 & 0.022 & 0.031 & 0.058 & 0.109 & 0.189 \\
            &      & Accuracy  & $\minus 0.004$ & $\minus 0.004$ & $\minus 0.004$ & $\minus 0.004$ & $\minus 0.002$ & 0.011 & 0.064 \\
            \cline{3-10}
            & 0.70 & Precision & 0.019 & 0.020 & 0.021 & 0.031 & 0.057 & 0.123 & 0.221 \\
            &      & Accuracy  & $\minus 0.006$ & $\minus 0.006$ & $\minus 0.006$ & $\minus 0.005$ & $\minus 0.005$ & $\minus 0.002$ & $\minus 0.064$ \\    
    \hline  
    \end{tabular}
    %% -------------------------------------------------------------------------------- %%
    \end{center}
    \caption{
        \todo{Placeholder}
        Summary of the precisions and accuracies of \forced{} PSF colors in both 
...
\begin{table*}
    ...
    \hline
    $g$ & 0.45 & Precision & 0.111 & 0.156 & 0.161 & 0.152 & 0.176 & 0.196 \\
        &      & Accuracy  & $\minus 0.060$ & $\minus 0.036$ & $\minus 0.004$ & 0.021 & 0.009 & $\minus 0.005$ \\
        \cline{3-9}
        & 0.70 & Precision & 0.137 & 0.161 & 0.138 & 0.147 & 0.181 & 0.202 \\
        &      & Accuracy  & 0.018 & $\minus 0.008$ & 0.029 & 0.040 & 0.028 & 0.012 \\
    \hline
    $r$ & 0.45 & Precision & 0.197 & 0.151 & 0.147 & 0.167 & 0.179 & 0.211  \\
        &      & Accuracy  & $\minus0.036$ & $\minus 0.015$ & 0.033 & 0.033 & 0.017 & 0.012  \\
        \cline{3-9}
        & 0.70 & Precision & 0.167 & 0.119 & 0.142 & 0.168 & 0.189 & 0.232 \\
        &      & Accuracy  & $\minus 0.024$ & 0.023 & 0.050 & 0.036 & 0.025 & 0.022 \\    
    \hline
    $i$ & 0.45 & Precision & 0.173 & 0.157 & 0.154 & 0.168 & 0.183 & 0.218 \\
        &      & Accuracy  & $\minus 0.023$ & 0.008 & 0.004 & 0.017 & $\minus 0.001$ & $\minus 0.006$ \\
        \cline{3-9}
        & 0.70 & Precision & 0.154 & 0.157 & 0.153 & 0.174 & 0.193 & 0.246 \\
        &      & Accuracy  & 0.017 & 0.043 & 0.040 & 0.021 & 0.003 & $\minus 0.013$ \\
    \hline
    $z$ & 0.45 & Precision & 0.171 & 0.176 & 0.165 & 0.182 & 0.201 & 0.241 \\
        &      & Accuracy  & $\minus0.006$ & 0.042 & 0.038 & 0.018 & $\minus 0.002$ & $\minus 0.012$ \\
        \cline{3-9}
        & 0.70 & Precision & 0.168 & 0.155 & 0.167 & 0.185 & 0.222 & 0.278 \\
        &      & Accuracy  & 0.027 & 0.046 & 0.045 & 0.028 & 0.009 & $\minus 0.034$ \\    
    \hline
    $y$ & 0.45 & Precision & 0.179 & 0.169 & 0.178 & 0.197 & 0.241 & 0.308 \\
        &      & Accuracy  & 0.011 & 0.056 & 0.044 & 0.014 & $\minus 0.067$ & $\minus 0.244$ \\
        \cline{3-9}
        & 0.70 & Precision & 0.169 & 0.164 & 0.169 & 0.194 & 0.253 & 0.315 \\
        &      & Accuracy  & 0.041 & 0.052 & 0.048 & 0.020 & $\minus 0.057$ & $\minus 0.299$ \\    
    \hline  
    \end{tabular}
    %% -------------------------------------------------------------------------------- %%
    \end{center}
    \caption{
        \todo{Placeholder}
        Summary of the precisions and accuracies of \forced{} \cmodel{} magnitudes in 
...
\begin{table*}
    ...
    \cline{4-10}
           & FWHM ($$\asec) &             & 19.0 & 20.0 & 21.0 & 22.0 & 23.0 & 24.0 & 25.0 \\
    \hline
    $(g-i)$ & 0.45 & Precision & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
            &      & Accuracy  & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
            \cline{3-10}
            & 0.70 & Precision & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
            &      & Accuracy  & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
    \hline
    $(i-y)$ & 0.45 & Precision & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
            &      & Accuracy  & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
            \cline{3-10}
            & 0.70 & Precision & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\
            &      & Accuracy  & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 & 0.01 \\    
