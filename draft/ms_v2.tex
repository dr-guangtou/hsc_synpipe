...
\section{Hyper-Suprime Cam Subaru Strategic Program (HSC Survey)}
    ...
    scientific goals of HSC survey, which include WL cosmology, galaxy evolution 
    ...
    uniform coverage.}; for the remaining 3 bands, 20 mins of exposure time and 6 
...
\subsection{ \synpipe{} Basic Design}
    ...
    \begin{itemize}
        ...
        \item \textbf{Authentic Data Processing}:
            To follow the data reduction process as realistic as possible, we choose to
...
\subsubsection{Injection of Synthetic Objects into Single-\visit{} Image}
    ...
    Since each HSC CCD consists of four amplifiers, each with different characteristics,
...
\subsubsection{Stacking and Multi-band Measurements}
    ...
    with a unique label.
    In case of multiple matches, the user can choose between returning only the 
...
\subsection{Test Data}
    ...
    \begin{enumerate}
        ...
        \item Can represent good and bad seeing condition in the current $i$-band
            ...
            central S/N on the \coadd{} images, hence it also impacts the
...
%% ------------------------------------------------------------------------------------ %%
    ...
    \begin{enumerate}
        ...
        \item \synpipe{} now works in ``unit'' of \visit{} for single exposure
            test, and \tract{} for test of \coadd{} images.
